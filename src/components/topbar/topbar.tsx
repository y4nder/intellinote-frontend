...
export default function TopBar() {
    ...
    return (
        <>
            <div className="sticky top-0 z-50 bg-card flex items-center justify-between mb-8 px-4 py-2  backdrop-blur-md">
                {isCollapsed ?
                ...
                <div className="flex justify-center">
                    <button onClick={toggleSearchDialog}
                        className="flex items-center min-w-[400px] gap-2 rounded-3xl bg-white px-4 py-2 text-sm text-muted-foreground dark:border-white/20 dark:bg-brand h-12 hover:shadow-md transition-all duration-300"
                    >
