...
export default function FolderCard({ folder }: FolderCardProps) {
	...
	return (
		<div
			className="bg-background dark:bg-surface-container-low p-4 rounded-3xl shadow-sm hover:shadow-md cursor-pointer group active:scale-95"
		...
		>
			<div className="flex items-center mb-3">
				...
				<div className="ml-3">
					<h3 className="font-medium text-gray-800 dark:text-primary group-hover:text-primary">{name}</h3>
