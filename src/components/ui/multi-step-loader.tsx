				...
				return (
					...
					>
						<div>
							...
							{index <= value && (
								<CheckFilled
									className={cn("text-black dark:text-white", value === index && "text-black dark:text-primary opacity-100")}
								/>
							)}
						</div>
						<span className={cn("text-secondary", value === index && "text-black dark:text-primary opacity-100")}>
							{loadingState.text}
						</span>
					</motion.div>
				);
