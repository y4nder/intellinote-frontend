...
export const PageLoadingProgress = React.forwardRef<HTMLDivElement, PageLoadingProgressProps>(({ className, loading, ...props }, ref) => {
	...
	return (
		<motion.div
			ref={ref}
			className={cn(`fixed inset-x-0 top-0 z-50 h-[2.5px] origin-left bg-gradient-to-r ${randomGradient}`, className)}
