...
import SettingsPage from "@/app/pages/(root)/main/(home)/settings";
			...
			>
				<div className="flex items-center p-4 justify-between">
					<div className="flex gap-2 items-center">
						<div
							className={cn(
								"rounded-full w-8 h-8 p-2 flex items-center justify-center text-white",
								`bg-gradient-to-r ${gradientsCombos[2]}`
							)}
						>
